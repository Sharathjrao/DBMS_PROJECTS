...
<body class="container">
	...
	style="font-family: 'Abril Fatface', cursive;">  SHOPPING MALL MANAGMENT SYSTEM</h1>
	...
	$query = " SELECT `name`, `image`, `price`, `discount` FROM `products` order by id ASC ";
		...
		<div class="col-lg-3 col-md-3 col-sm-12">
			...
			<form>
				<div class="card">
					...
					<div class="card-body">
						 <img src="<?php echo
					 $products['image'];  ?>" alt="phone" class="img-fluid mb-2" >

					 <h6> &#8377; <?php echo $products['price'];  ?><span> (<?php echo 
					 	$products['discount'];  ?>% off) </span> </h6> 
